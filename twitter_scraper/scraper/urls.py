...
urlpatterns = [
    ...
    path("twitter/api/v1/get-trending-hashtag/", views.get_trending_tweets, name="get_trending_tweets"),
    path("twitter/api/v1/get-tweets-by-id/", views.get_tweets_by_id, name="get_tweets_by_id"),
